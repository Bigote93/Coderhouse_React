                        ...
                        <div>
                            ...
                            <ul className="flex gap-8 item-center justify-center py-12">
                                <li className="inline-flex border-b-2 border-b-2 border-white hover:border-indigo-button transition duration-300 ease-in-out ">
                                    <a href="/servicios/algo1" className="mt-6 text-lg font-medium leading-8 text-gray-700 sm:text-center">
                                        Banco Evaluaciones
                                    </a>
                                </li>
                                <li className="inline-flex border-b-2 border-b-2 border-white hover:border-indigo-button transition duration-300 ease-in-out ">
                                    <a href="/servicios/algo2" className="mt-6 text-lg font-medium leading-8 text-gray-700 sm:text-center">
                                        Banco preguntas
                                    </a>
                                </li>
                                <li className="inline-flex border-b-2 border-b-2 border-white hover:border-indigo-button transition duration-300 ease-in-out ">
                                    <a href="/servicios/algo3" className="mt-6 text-lg font-medium leading-8 text-gray-700 sm:text-center">
                                        Producto de muestra
                                    </a>
                                </li>
                            </ul>
